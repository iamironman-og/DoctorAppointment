			...
			else
				{
					...
					if($email!==false)
					{
						...
						if($user->updatePasswordByEmail($email,$password)){
								echo "<h2 style='color:green'>You password has been reset successfully</h2><br>";
								if($key==0)
								{
									echo '<a href="../login/patientLogin.html>Go to login page">Go to login page</a>';
								}elseif ($key==1) {
									echo '<a href="../login/doctorLogin.html>Go to login page">Go to login page</a>';
								}elseif ($key==2) {
									echo '<a href="../login/adminLogin.html>Go to login page">Go to login page</a>';
								}
								exit();
						}
						else {
